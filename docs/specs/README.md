...
| SPEC-031 | Public Sales API and Backend Contract | DRAFT | 0.1.0 | SALE-2 | SPEC-000 v0.2.0, SPEC-001, SPEC-030; compatible with SPEC-011 | `SPEC-031-PUBLIC-SALES-API-AND-BACKEND-CONTRACT.md` |
...
SPEC-000 v0.2.0 and SPEC-030 v0.1.0 are approved. The formal review of
SPEC-031 v0.1.0 found no actionable findings and recommends human approval.
SPEC-031 remains `DRAFT` with no implementation or production authority. F0-E
