...
status: SUPERSEDED
superseded_by: see change log / replacing APPROVED v0.2.0
version: 0.1.0
phase: SALE-3
...
```text
STATUS: SUPERSEDED — Replaced by v0.2.0 APPROVED (2026-08-04)
Canonical replacing contract: see docs/specs/ (non-archive path)
```
...
| 0.1.0 | 2026-08-04 | SUPERSEDED | Leandro Espinosa, CEO / Project Owner | Superseded by SPEC-032 v0.2.0 APPROVED. Archive preserved for historical authority. |
